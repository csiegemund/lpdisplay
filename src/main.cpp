...
#define U8G2_OBJ_B(C, R, B, I) U8G2_ ## C ## _ ## R ## _ ## B ## _1_ ## I 
      ...
      U8G2_OBJECT_B(DISP_CONTROLLER, DISP_RESOLUTION, DISP_BRAND, 3W_HW_SPI) u8g2(DISP_ROTATION, SPI_CS, SPI_RS);  
    #elif DISP_INTERFACE == SPI_4W
      U8G2_OBJECT_B(DISP_CONTROLLER, DISP_RESOLUTION, DISP_BRAND, 4W_HW_SPI) u8g2(DISP_ROTATION, SPI_CS, SPI_DC, SPI_RS); 
    #elif DISP_INTERFACE == NO_IF
    ...
    #elif DISP_INTERFACE == SPI_3W
      U8G2_OBJECT(DISP_CONTROLLER, DISP_RESOLUTION, 3W_HW_SPI) u8g2(DISP_ROTATION, SPI_CS, SPI_RS);  
    #elif DISP_INTERFACE == SPI_4W
      U8G2_OBJECT(DISP_CONTROLLER, DISP_RESOLUTION, 4W_HW_SPI) u8g2(DISP_ROTATION, SPI_CS, SPI_DC, SPI_RS); 
    #elif DISP_INTERFACE == NO_IF
      U8G2_NULL u8g2(U8G2_R0);
    #endif
#endif
